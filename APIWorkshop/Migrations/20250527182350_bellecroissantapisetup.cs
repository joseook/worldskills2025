...
{
    /// <inheritdoc />
    public partial class bellecroissantapisetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Churned = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
